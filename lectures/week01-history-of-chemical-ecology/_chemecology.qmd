## What is Chemical Ecology {background-color="#1B4332"}
...
- **1959**: identification of **bombykol**, the moth sex pheromone —
  the same year Fraenkel's paper reframed plant "waste" compounds as
  defenses (sound familiar? — that's Story 1 and Story 2)
- Rise of **multidisciplinary research**, combining biology and
  chemistry into a single field

::: {.notes}
~1 min. Explicit callback to the synthesis slide's 1959 coincidence —
the class has already seen this pattern before we name it.
:::
